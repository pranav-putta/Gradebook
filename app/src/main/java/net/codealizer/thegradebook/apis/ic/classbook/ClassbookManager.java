...
public class ClassbookManager implements Serializable {
    ...
    public ArrayList<PortalClassbook> getPortalClassbooks() {
        ArrayList<PortalClassbook> courses = new ArrayList<>();
        ...
        Collections.sort(courses, new PortalClassbook.Compare());
