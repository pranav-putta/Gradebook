...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SwitchPreference toggleNotifications = (SwitchPreference) findPreference("notifications_new_message");
        toggleNotifications.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object o) {
                ...
                try {
                    if (!toggleNotifications.isChecked()) {
                        stopService(new Intent(SettingsActivity.this, UpdateResultReciever.class));
                        SessionManager.alarm.cancel(SessionManager.pendingIntent);
                    }
                } catch (Exception ex) {
